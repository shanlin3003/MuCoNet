...
class DCGS(nn.Module):
    def __init__(self, in_planes):
        super(DCGS, self).__init__()
...
class SACM(nn.Module):
    def __init__(self, in_channels, branch_ratio=0.25):
        ...
        self.conv2 = GPSSM(gc, d_conv=3, d_state=8)
        
        self.conv3 = ASPPConv(gc, gc, 12)
        
        self.conv4 = GPSSM(gc, d_conv=7, d_state=24)
...
class MuCoNet(nn.Module):
    def __init__(self, dim=32, dims=[64, 128, 320, 512]):
        ...
        self.SACM_c4 = SACM(c4_in_channels)
        self.SACM_c3 = SACM(c3_in_channels)
        self.SACM_c2 = SACM(c2_in_channels)
        self.SACM_c1 = SACM(c1_in_channels)
        ...
        self.dcgs_3 = DCGS(dim)
        self.dcgs_2 = DCGS(dim)
        self.dcgs_1 = DCGS(dim)
    ...
    def forward(self, x):
        ...
        _c4 = self.SACM_c4(c4)  # [1, 64, 11, 11]
        _c3 = self.SACM_c3(c3)  # [1, 64, 22, 22]
        _c2 = self.SACM_c2(c2)  # [1, 64, 44, 44]
        _c1 = self.SACM_c1(c1)
        ...
        sub3 = abs(_c3 - _c4)
        L34 = self.linear_fuse34(self.dcgs_3(_c3, _c4, sub3))
        O34 = L34
        ...
        L2 = self.linear_fuse34(self.dcgs_2(_c2, L34, sub2))
        O2 = L2
        ...
        _c = self.linear_fuse34(self.dcgs_1(_c1, L2, sub1))
